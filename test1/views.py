...
#        print(datetime.datetime.strptime(fooo.Tdate,'%Y.%m.%d').date()-datetime.datetime.now().date())
    ...
    course_now = course_table.objects.all().filter(Q(Skdd__contains='中')|Q(Skdd__contains='复')|Q(Skdd__contains='综')|Q(Skdd__contains='研')|Q(Skdd__contains='前')|Q(Skdd__contains='二')|Q(Skdd__contains='水')|Q(Skdd__contains='东'),Jc=Jieci_now,Skap__contains=week_now).values('jgxm','Dwmc','Xn','xq','Zc','Skap').distinct().order_by('jgxm')
    course_now1 = course_table.objects.all().filter(Q(Skdd__contains='中')|Q(Skdd__contains='复')|Q(Skdd__contains='综')|Q(Skdd__contains='研')|Q(Skdd__contains='前')|Q(Skdd__contains='二')|Q(Skdd__contains='水')|Q(Skdd__contains='东'),Jc='7-8',Skap__contains=week_now).values('jgxm','Dwmc','Xn','xq','Zc','Skap').distinct().order_by('jgxm')
